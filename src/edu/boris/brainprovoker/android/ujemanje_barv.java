...
public class ujemanje_barv extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		igra3 = new Intent(this, hitri_prsti.class);
	...
	protected Dialog onCreateDialog(int id) {
		...
		case START_DIALOG:
			...
			builder.setMessage(
					"Navodila: Èe se pomen besede in barva te besede ujemata pritisnite zelen, v nasprotnem primeru pa rdeè gumbek. \n Pripravljeni?")
					.setCancelable(false)
		...
		case FINISH_DIALOG:
			builder = new AlertDialog.Builder(this);
			builder.setMessage("Koncano: Tvoj rezultat: " + app.player.score)
					.setCancelable(false)
					.setPositiveButton("Na naslednjo igro",
							new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog,
										int id) {
